...
const Head = () => {
    ...
    const getSearchSuggestion = async () => {
        ...
        // update the query and result in cache for future search
    ...
    useEffect(() => {
        ...
        // make an api call on every keypress
